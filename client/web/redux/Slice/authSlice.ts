...
import { IUser } from "@/apis/userApi";
...
export const loginThunk = createAsyncThunk(
    'auth/login',
    async (data: { account: string; password: string }, { rejectWithValue }) => {
        try {
...
const registerThunk = createAsyncThunk('auth/register-owner', async ({ username, password, email }: { username: string, password: string, email: string }, { rejectWithValue }) => {
    try {
